...
//                                            echo '<pre>';print_r($item); die;
                                                        ...
                                                        <div class="thumbnail">
                                                            ...
                                                            <div class="caption" >
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12 col-md-12 ">
                                                                        <a id="'.$item['item_id'].'_btn_view" target="_blank" href="'.base_url($this->router->fetch_class().'/view_item/'.$item['item_id'].'/'.(($category_id1!='')?$category_id1:0).'_'.$order_id.'/'.$cur_page1).'" class="itm_btn_view btn btn-default center-block "  >View</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div class="scroller-status">
      ...
      <p class="pagination">
          <a class="pagination__next" href="<?php echo base_url($this->router->fetch_class().'/image_loader/'.$category_id1.'_'.$order_id.'/'.($cur_page1+1));?>">Next page</a>
      </p>
