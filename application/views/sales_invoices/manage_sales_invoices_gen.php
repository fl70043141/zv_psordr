    ...
    <section  class="content"> 
        ...
        <div class="">
            ...
            <?php echo form_open($this->router->fetch_class()."/validate", 'id="form_search" class="form-horizontal"')?>  
                <?php echo form_hidden('so_gen_type','regular');?>
                    <div class="box-body">
...
//                                                            echo '<pre>';print_r($so_data);  
                                                            echo '
                                                                <tr style="padding:10px" id="trso_'.$so_item['id'].'">
                                                                    <td><span id="'.$row_count.'_row_cntr" class="row_counter_cls"></span></td>
                                                                    <td><input class="itemcode_cls"  hidden name="inv_items['.$row_count.'][item_code]" value="'.$so_item['item_code'].'">'.$so_item['item_code'].'</td>
                                                                    ...
                                                                    <td align="center"><input hidden name="inv_items['.$row_count.'][item_quantity]" value="'.$so_item['units'].'"><input hidden name="inv_items['.$row_count.'][item_quantity_2]" value="0">
                                                                        <input hidden name="inv_items['.$row_count.'][unit_abbreviation]" value="'.$so_item['unit_abbreviation'].'"><input hidden name="inv_items['.$row_count.'][item_quantity_uom_id]" value="'.$so_item['unit_uom_id'].'"><input hidden name="inv_items['.$row_count.'][item_quantity_uom_id_2]" value="'.$so_item['secondary_unit_uom_id'].'">
                                                                         '.$so_item['units'].' '.$so_item['unit_abbreviation'].'</td> 
                                                                    <td id="td_unitcost_'.$row_count.'"  align="right"><input class="cell_cur_value"  value="'.$so_data['currency_value'].'" hidden><input hidden class="cell_price" name="inv_items['.$row_count.'][item_unit_cost]" value="'.$so_item['unit_price'].'"><span class="cell_price_text">'. number_format($so_item['unit_price'], 2).'</span></td>
                                                                    ...
                                                                    <td id="td_to_'.$row_count.'" align="right"><input class="cell_cur_value" hidden name="inv_items['.$row_count.'][item_cur_value]" value="'.$so_data['currency_value'].'"><input class="item_tots cell_price" hidden name="inv_items['.$row_count.'][item_total]" value="'.$so_item['sub_total'].'"><span class="cell_price_text">'. number_format($so_item['sub_total']).'</span></td>
