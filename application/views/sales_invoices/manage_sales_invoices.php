...
<div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <div class="">
            <a href="<?php echo base_url('Sales_order_items/view/'.((isset($so_data['id'])?$so_data['id']:"")));?>" class="btn btn-app  <?php echo (isset($so_data['id'])?"":"hide");?>"><i class="fa fa-backward"></i>Back to Order</a>
