...
<script>
    $(document).ready(function(){ 
        $('.add_new_btn').click(function(){ 
            ...
            var dd_id = 0;
            switch(elm_name){
                case 'cutter': dd_id = 19; elm_title = 'Cutter'; break;
                case 'lab': dd_id = 4; elm_title = 'Laboratory'; break;
...
//                            fl_alert('info',)    $('#res_op_mod2').html(dd_data); 
                                ...
                                switch(input_dpname_id){
                                    case '4': $select = $('#gem_lab_id'); break;
                                    case '19': $select = $('#gem_cutter_id'); break;
